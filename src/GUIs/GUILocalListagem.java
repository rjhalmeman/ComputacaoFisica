...
// @author Radames
public class GUILocalListagem extends JDialog {
    ...
    public GUILocalListagem(List<Local> texto, int posX, int posY, Dimension dimensao) {
        setTitle("Listagem de Local");
        ...
        String[] colunas = new String[]{"idLocal",
            "nomeLocal",};
        ...
        for (int i = 0; i < texto.size(); i++) {
            String[] linha = new String[]{String.valueOf(texto.get(i).getIdLocal()),
                String.valueOf(texto.get(i).getNomeLocal()),};
            model.addRow(linha);
        }
