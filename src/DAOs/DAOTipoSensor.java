...
public class DAOTipoSensor extends DAOGenerico<TipoSensor> {
    ...
    private List<TipoSensor> lista = new ArrayList<>();
    ...
    public List<TipoSensor> listByNome(String nome) {
        return em.createQuery("SELECT e FROM TipoSensor e WHERE e.idTipoSensor) LIKE :nome").setParameter("nome", "%" + nome + "%").getResultList();
    }

    public List<TipoSensor> listById(int id) {
        return em.createQuery("SELECT e FROM TipoSensor + e WHERE e.nomeTipoSensor= :id").setParameter("id", id).getResultList();
    }
    ...
    public static void main(String[] args) {
        ...
        List<TipoSensor> listaTipoSensor = daoTipoSensor.list();
        for (TipoSensor tipoSensor : listaTipoSensor) {
            System.out.println(tipoSensor.getIdTipoSensor() + "-" + tipoSensor.getNomeTipoSensor());
        }
    }
}
